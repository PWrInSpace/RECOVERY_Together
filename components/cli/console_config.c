...
//     gpio_set_level(recovery_system.pilot_deploy_pin, 1);
...
//     ESP_LOGI(TAG, "armStatus: %d", telemetrum_device.armed);
//     ESP_LOGI(TAG, "apogeeDetection: %d", telemetrum_device.apogee_detected);
//     return 0;
// }
//
// int telemetrum_arm_cmd(int argc, char** argv) {
//     return cots_arming(COTS_DEVICE_1);
// }
//
// int telemetrum_disarm_cmd(int argc, char** argv) {
//     return cots_disarm(COTS_DEVICE_1);
// }
//
